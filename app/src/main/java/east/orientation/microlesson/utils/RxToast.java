...
public class RxToast {
    ...
    public static void showToastShort(String str) {
        Toast.makeText(MicroApp.getInstance().getApplicationContext(), str, Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastShort(int resId) {
        Toast.makeText(MicroApp.getInstance().getApplicationContext(), MicroApp.getInstance().getApplicationContext().getString(resId), Toast.LENGTH_SHORT).show();
    }
    ...
    public static void showToastLong(String str) {
        Toast.makeText(MicroApp.getInstance().getApplicationContext(), str, Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToastLong(int resId) {
        Toast.makeText(MicroApp.getInstance().getApplicationContext(), MicroApp.getInstance().getApplicationContext().getString(resId), Toast.LENGTH_LONG).show();
    }
    ...
    public static void showToast(String msg) {
        if (mToast == null) {
            mToast = Toast.makeText(MicroApp.getInstance().getApplicationContext(), msg, Toast.LENGTH_LONG);
        } else {
            mToast.setText(msg);
        }
        mToast.show();
    ...
    public static void showToast(int resId) {
        if (mToast == null) {
            mToast = Toast.makeText(MicroApp.getInstance().getApplicationContext(), MicroApp.getInstance().getApplicationContext().getString(resId), Toast.LENGTH_LONG);
        } else {
            mToast.setText(MicroApp.getInstance().getApplicationContext().getString(resId));
        }
        mToast.show();
    }
