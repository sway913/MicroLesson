...
public class VoiceTapItemViewDelegate implements ItemViewDelegate<LocalVoice> {

    @Override
    public int getItemViewLayoutId() {
        return R.layout.layout_voice_tap_make_item;
    }
    ...
    @Override
    public void convert(ViewHolder holder, LocalVoice localVoice, int position) {
